...
void FFreeImageWrapper::FreeImage_Initialise(bool bLoadLocalPluginsOnly)
{
	...
	{
		::bytangs::FreeImage_Initialise((BOOL)bLoadLocalPluginsOnly);
	}
}
...
FTifTextureHelper::FTifTextureHelper()
{
...
bool FTifTextureHelper::Load(const uint8 * Buffer, uint32 Length)
{
	...
	{
		UE_LOG(LogTemp, Error, TEXT("Can't flip TIFF image"));
	}
	...
	{
		UE_LOG(LogTemp, Error, TEXT("Unsupported TIFF format"));
		return false;
	}
...
bool FTifTextureHelper::ConvertToRGBA16()
{
...
void FTifTextureHelper::SetError(const FString& InErrorMessage)
{
	ErrorMessage = InErrorMessage;
}

FString FTifTextureHelper::GetError()
{
	return ErrorMessage;
}

bool FTifTextureHelper::IsValid()
{
	return bIsValid;
}
