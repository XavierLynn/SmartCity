...
TEXTURERUNTIMEIMPORTER_API void GetPSDHeader(const uint8* Buffer, FPSDFileHeader& Info);
TEXTURERUNTIMEIMPORTER_API bool ReadPSDData(uint8* OutData, const uint8*& Buffer, FPSDFileHeader& Info);
